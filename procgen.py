...
item_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [(entity_factories.health_potion, 65)],
...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [(entity_factories.orc, 30)],
    3: [(entity_factories.troll, 40)],
...
def place_entities(i: int, room: RectangularRoom, dungeon: GameMap, floor_number: int) -> None:
    ...
    # add miner and thief2 manually for training
    monsters = []
    items = []
    #if i%2==0:
    monsters.append(entity_factories.miner)
    # for training 5 items
    for i in range(5):
