...
class ThiefEnemy3(BaseAI):
    ...
    def __init__(self, entity: Actor):
        ...
        self.params = {
            # Model backups
            'load_file': None, #tf.compat.v1.train.latest_checkpoint('saves/'),
            'save_file': None,
            'save_interval' : 10000,
    ...
    def getMove(self):
        # Exploit / Explore
        #print('Exploit/Explore',np.random.rand(),self.params['eps'])
    ...
    def final(self):
        ...
        log_file = open('log_file_1.txt','a')
    ...
    def getStateMatrices(self):
        ...
        observation[1] = getPacmanMatrix()
        observation[2] = getGhostMatrix()
        observation[3] = getFoodMatrix()
    ...
    def save_agent(self):
        # Save model
        #if self.local_cnt > self.params['train_start'] and self.local_cnt % self.params['save_interval'] == 0:
        self.qnet.save_ckpt('saves/model_' + str(self.cnt) + '_' + str(self.numeps))
        print('Model saved')
