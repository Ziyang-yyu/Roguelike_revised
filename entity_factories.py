...
from components.ai import HostileEnemy, CompetitiveEnemy, ThiefEnemy, ThiefEnemy2, ThiefEnemy3
...
player = Actor(
    ...
    name="Player",
    #ai_cls=HostileEnemy,
    ai_cls=ThiefEnemy3, #training
    #ai_cls = ThiefEnemy, # comparing
    equipment=Equipment(),
    fighter=Fighter(hp=1, base_defense=0, base_power=0), # change to 30
